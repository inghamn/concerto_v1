...
class Template {
    ...
    public function create_template($name_in, $height_in, $width_in, $file, $creator_in = '', $hidden_in = false) {
    ...
    public function update_field($field_id_in, $name_in, $type_id_in, $style_in, $left_in, $top_in, $width_in, $height_in) {
    ...
    public function add_field($name_in, $type_in, $style_in, $left_in, $top_in, $width_in, $height_in) {
    ...
    public function list_all($where = '') {
    ...
    public function destroy() {
        ...
        */
    public function preview($width=400, $height=300, $act_field = false, $strict_size = false) {
